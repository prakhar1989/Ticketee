Feature: Gmail
  ...
  Background:
    Given there are the following users:
      ...
      | prakhar1989@gmail.com | password |
    And Action Mailer delivers via SMTP
    Given there is a project called "TextMate 2"
    And "alice@ticketee.com" can view the "TextMate 2" project
    And "prakhar1989@gmail.com" can view the "TextMate 2" project
    And "prakhar1989@gmail.com" has created a ticket for this project:
      | title        | description       |
